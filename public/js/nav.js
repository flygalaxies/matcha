...
function renderNotif(type, date, id, name) {
	...
	return ('<li class="one-notif"><span class="icon-notif glyphicon glyphicon-' + icon + '"></span><ul class="infos-notifs"><li><a href="/user/' + id + '">' + name + '</a> <strong>' + type + 'ed</strong> your profile.</li><li class="text-muted"><small><span class="glyphicon glyphicon-calendar" ></span> ' + $.format.prettyDate(date) + '</small></li></ul></li>');
}
